    ...
    <div className="w-full bg-zinc-950 bg-opacity-50 h-fit flex p-2 flex-col justify-between">
      ...
      <div className="w-full bg-opacity-50 h-48 p-2 flex gap-4 justify-around">
        <div className="flex flex-col">
          <div className="flex w-full bg-red-700 p-2 rounded-t border-black border-b-2 border-opacity-10 justify-center font-extrabold">
            Cursos
          </div>
          <div className="flex bg-red-700 rounded-b">
